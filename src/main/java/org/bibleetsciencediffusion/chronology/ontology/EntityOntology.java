...
public interface EntityOntology {
    ...
    Entity ISRAEL = new Entity(Entity.ENGLISH,"Israel").addName(Entity.FRENCH,"Israël").addClass(Concept.COUNTRY);
    Entity CANAAN = new Entity(Entity.ENGLISH,"Canaan").addName(Entity.FRENCH,"Canaan").addClass(Concept.COUNTRY);;
    Entity EGYPT = new Entity(Entity.ENGLISH,"Egypt").addName(Entity.FRENCH,"Egypte").addClass(Concept.COUNTRY);;



    Entity ABRAHAM = new Entity(Entity.ENGLISH,"Abram").addClass(Concept.HUMAN)
                        .addProcess(
